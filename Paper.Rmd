...
Negativity Bias Theorem argues that humans or even animals have tendencies to be more aware of negative entities than positive ones. Someone else's hair in one's meal has the potential of ruining the whole meal. On the contrary a plate of hair will not turn to a delicious meal just because there is a slice of a delicious pizza on top of the hair. @rozin2001 explains the Negativity Bias Theorem by describing it with four main aspects. Namely, Negative Potency, Steeper Negative Gradients, Negative Dominance and Negative Differentiation [@rozin2001; @sen2007; @eslami2018]. Loss Aversion has a strong connection to Negativity Bias Theorem since negative cues might be used as an early warning against potential losses [@herr1991].
...
**Negativity Dominance** asserts that a balanced mixture of positive and negative evaluations creates a perception of negativity. This means that negative entities have higher weight than positive entities. This is apparent in religions. For the most of the religions being a good and pious person takes time, demands utmost care. However, tainting this image is very easy with certain actions such as murder or pre-martial intercourse.
