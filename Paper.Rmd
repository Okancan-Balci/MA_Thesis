...
This study collected Online Customer Reviews data from two different sources (IMDB and BestBuy) and analyzed the data within the context of consumer uncertainty. Negativity Bias Theorem, Prospect Theory and Search / Experience goods paradigm from information economics were used as an theoretical engine to explain the information gathering process of an average consumer. Results showed similarities from the existing Review Helpfulness literature. However, once again it should be noted that the literature has many conflicting results.
