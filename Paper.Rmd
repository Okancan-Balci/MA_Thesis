...
The classification of Experience and Search goods plays a moderating role in the literature [@mudambi2010; @sun2019; @baek2012; @lee2016]. Some of these studies showed that Review Length has a greater effects for search products than experience products [@mudambi2010; @baek2012; @lee2016]. These findings suggest that search goods can be evaluated in a more objective way than experience goods. The moderating effect of product type on Review Extremity, on the contrary, is disputable. Mudambi (2010) @mudambi2010 showed that moderate reviews are more helpful for experience products than search products. Baek (2012) @baek2012 and Lee (2016) @lee2016 had the opposite results which indicated that more extreme reviews (negative or positive) is more helpful more search goods than experience goods.
...
-   might explain that goods within the same group can show different characteristics
